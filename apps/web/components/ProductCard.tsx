        ...
        <Link href={`/produto/${id}`} className="flex flex-col group cursor-pointer">
            ...
            <div className="relative w-full aspect-square bg-[#f8f9fa] dark:bg-[#2a2a2a] rounded-2xl p-6 md:p-12 mb-4 transition-all duration-300 group-hover:shadow-lg overflow-hidden border border-gray-100 dark:border-gray-800">
                ...
                <button
                    ...
                    className="absolute bottom-4 right-4 bg-black text-white rounded-full w-10 h-10 shadow-lg hover:bg-gray-800 transition-all duration-300 flex items-center justify-center group/btn hover:w-32 overflow-hidden"
                >
