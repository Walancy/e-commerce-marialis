...
const categories = ['Secadores', 'Chapinhas', 'Modeladores', 'Máquinas de Corte', 'Acessórios'];
...
const allProducts = Array.from({ length: 20 }, (_, i) => ({
    ...
    title: `Equipamento Pro ${i + 1}`,
    brand: brands[i % brands.length] || 'Brand',
    price: i % 2 === 0 ? 'R$ 899,00' : 'R$ 459,90',
    ...
    return (
        <main className="min-h-screen bg-white dark:bg-[#1a1a1a]">
            ...
            <div className="pt-24 pb-20 px-4 lg:px-20 max-w-[1600px] mx-auto">
                {/* Breadcrumbs / Title */}
                <div className="mb-8">
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Equipamentos Profissionais</h1>
                    <p className="text-gray-500 text-sm">Home / Equipamentos</p>
                </div>
